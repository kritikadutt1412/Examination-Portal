...
<body>
 <form name="quiz" action ="result.jsp" method="post">
...
PreparedStatement pst=con.prepareStatement("select ques,opt_a,opt_b,opt_c,opt_d,cor_ans from qbank1 where(ename ='"+opt+"')");
